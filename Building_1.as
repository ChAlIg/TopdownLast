package  {
	...
	public class Building_1 extends MovieClip {
		...
		var curM:Matrix;
		public var downer:int = 25;
		public var upper:int = 75;
		var dx:int;
		var dy:int;
		var gSize:int;
		var floors:Number;
		...
		public function Building_1 (main: Game, X: int, Y: int, groundSize: int = 200, fls: Number = 8): void {
			this.x = X;
			this.y = Y;
			game = main;
			gSize = groundSize;
			...
			a = new Wall_1();
			a.scaleX = a.scaleY = gSize/50;
			a.y = gSize/2;
			basicMa = a.transform.matrix;
			addChild(a);
			ma = new Mask_1();
			ma.scaleX = ma.scaleY = gSize/50;
			ma.y = gSize/2;
			addChild(ma);
			a.mask = ma;
			
			b = new Wall_1();
			b.scaleX = b.scaleY = gSize/50;
			b.x = gSize/2;
			b.rotation = -90;
			basicMb = b.transform.matrix;
			addChild(b);
			mb = new Mask_1();
			mb.scaleX = mb.scaleY = gSize/50;
			mb.x = gSize/2;
			mb.rotation = -90;
			addChild(mb);
			b.mask = mb;
			...
			c = new Wall_1();
			c.scaleX = c.scaleY = gSize/50;
			c.x = -gSize/2;
			c.rotation = 90;
			basicMc = c.transform.matrix;
			addChild(c);
			mc = new Mask_1();
			mc.scaleX = mc.scaleY = gSize/50;
			mc.x = -gSize/2;
			mc.rotation = 90;
			addChild(mc);
			c.mask = mc;
			...
			d = new Wall_1();
			d.scaleX = d.scaleY = gSize/50;
			d.y = -gSize/2;
			d.rotation = 180;
			basicMd = d.transform.matrix;
			addChild(d);
			md = new Mask_1();
			md.scaleX = md.scaleY = gSize/50;
			md.y = -gSize/2;
			md.rotation = 180;
			addChild(md);
			d.mask = md;
			...
			top = new Top_1();
			top.scaleX = top.scaleY = gSize/50;
			addChild(top);
		}
		public function loop(): void {
			...
			if (player != -1) {
				...
				top.x = a.x - dx*upper/downer;
				top.y = a.y - dy*upper/downer;
